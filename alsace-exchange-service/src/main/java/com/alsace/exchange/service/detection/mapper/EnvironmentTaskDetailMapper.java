...
public interface EnvironmentTaskDetailMapper {
   ...
   * App分页查询
   */
  List<EnvironmentTaskDetail> findFormPage(@Param("param") EnvironmentTaskDetail detail, @Param("formStatus") Integer formStatus,@Param("companyNameOrTaxCode") String companyNameOrTaxCode);
}
